...
REM - Installs Node.js dependencies for frontend (AFTER backend setup)
...
REM =============================================================================
REM BACKEND SETUP (MUST COMPLETE FIRST)
REM =============================================================================
...
REM Deactivate virtual environment (with error handling)
echo 🔧 Deactivating virtual environment...
call venv\Scripts\deactivate.bat 2>nul
echo ✅ Backend virtual environment deactivated
echo.

REM =============================================================================
REM FRONTEND SETUP (ALWAYS AFTER BACKEND)
REM =============================================================================
...
REM Always install Node.js dependencies (ensures they are properly installed)
